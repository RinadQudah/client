...
function editBook() {
  ...
  const baseUrl = `https://server-t3es.onrender.com/api/books/${urlSlug.slug}`;
  ...
  const createBook = async (e) => {
    ...
    try {
      const response = await fetch("https://server-t3es.onrender.com/api/books", {
        method: "PUT",
        body: formData,
      });
  ...
  const removeBook = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://server-t3es.onrender.com/api/books/" + bookId,
        {
          method: "DELETE",
        }
      );
        ...
        <form className="bookdetails" onSubmit={createBook}>
          <div className="col-1">
            ...
            {image ? (
              ...
              <img
                src={`https://server-t3es.onrender.com/uploads/${thumbnail}`}
                alt="preview image"
              />
            )}
            <input
